        ...
        <div class="relative w-full max-w-sm bg-white rounded-xl shadow-xl overflow-hidden animate-modal-in border border-zinc-200">
          ...
          <div class="px-6 pt-6 pb-5 text-center">
            ...
            <div :class="['w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4',
                          isDangerous ? 'bg-rose-50 text-rose-500' : 'bg-emerald-50 text-emerald-500']">
              <slot name="icon">
          ...
          <div class="px-6 pb-6 flex flex-col gap-2">
            ...
            <button
              class="w-full py-2.5 bg-zinc-50 text-zinc-600 text-sm font-medium rounded-lg hover:bg-zinc-100 transition-all disabled:opacity-50"
              @click="handleCancel"
              :disabled="loading"
            >
              {{ cancelText }}
