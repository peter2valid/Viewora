  ...
  routeRules: {
    ...
    '/view/**': { ssr: true, headers: {
      ...
      'Content-Security-Policy': [
        ...
        "connect-src 'self' blob: https://jtezuupnjncguzrpacap.supabase.co https://api.viewora.software https://media.viewora.software https://www.google-analytics.com https://app.posthog.com https://us.posthog.com wss://jtezuupnjncguzrpacap.supabase.co",
        "frame-src 'self'",
        "worker-src 'self' blob:",
        "upgrade-insecure-requests",
      ].join('; '),
